...
//        titleViewGroup.post(new Runnable() {
//            @Override
//            public void run() {
//                int titleHeight = titleViewGroup.getHeight();
//                Log.e("===height  ", " " + statusBarHeight + " :  " + titleHeight);
//                titleViewGroup.setPadding(0, statusBarHeight + 50, 0, 0);
//
//            }
//        });
