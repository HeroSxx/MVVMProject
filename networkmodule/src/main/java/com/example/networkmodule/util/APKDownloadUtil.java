...
public class APKDownloadUtil {
    ...
    public APKDownloadUtil(Context context, String fileName) {
        this.mContext = context;
        this.fileName = fileName;
    }

    //下载apk
    public void downloadAPK(String url, String title, String content) {
        //创建下载任务
    ...
    private void installAPK() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri apkUri = FileProvider.getUriForFile(mContext, "com.goldstone.goldstone_android.fileProvider", file);
